        ...
        child: GestureDetector(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(
                    border: Border.all(color: Color(0xFFF98B83)),
                    borderRadius: BorderRadius.circular(10)),
                child: new Text("EDIT PROFILE",
                    textAlign: TextAlign.center, style: Styles.minorStyle))));
  }

  void _addReview(BuildContext context, double ratingAsOrganiser,
      double ratingAsPiggybacker, String review) {
    ...
    ProfileStorage.instance
        .addReviewForOrganiser(reviewForOrganiser, userProfile.userId);
    ProfileStorage.instance
        .addReviewForPiggybacker(reviewForPiggybacker, userProfile.userId);
  }
                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                          Align(
                            alignment: Alignment.center,
                            child:
                                Text('For Organiser', style: Styles.titleStyle),
                          ),
                          SizedBox(height: 10),
                          Text('RATING', style: Styles.subtitleStyle),
                          SizedBox(height: 5),
                          Align(
                            alignment: Alignment.center,
                          ...
                          Padding(
                            ...
                            child: Text('REVIEW', style: Styles.subtitleStyle),
                          ),
                          Padding(
                          ...
                          Align(
                              ...
                              child: Padding(
                                ...
                                child: RaisedButton(
                                  ...
                                  onPressed: () {
                                    if (reviewFormKeyForOrganiser.currentState
                                        .validate()) {
                                      reviewFormKeyForOrganiser.currentState
                                          .save();
                                      _addReview(
                                          context,
                                          ratingAsOrganiser,
                ...
                Form(
                    ...
                    child: Column(children: [
                      ...
                      Align(
                        alignment: Alignment.center,
                        child:
                            Text('For Piggybacker', style: Styles.titleStyle),
                      ),
                      SizedBox(height: 10),
                      Text('RATING', style: Styles.subtitleStyle),
                      SizedBox(height: 5),
                          ...
                          child: Padding(
                            ...
                            child: RaisedButton(
                              ...
                              child: Text("Submit",
                                  style: Styles.popupButtonStyle),
                              onPressed: () {
                                if (reviewFormKeyForPiggybacker.currentState
                                    .validate()) {
                                  reviewFormKeyForPiggybacker.currentState
                                      .save();
                                  _addReview(
                                      context,
                                      ratingAsOrganiser,
        ...
        children: <Widget>[
          Container(
              constraints: BoxConstraints.loose(Size.fromHeight(
                  53.9 / 140.23 * MediaQuery.of(context).size.width)),
              decoration: BoxDecoration(
                    ...
                    Positioned(
                        ...
                        child: CircleAvatar(
                          ...
                          child: CircleAvatar(
                            radius: 47,
                            backgroundImage:
                                Image.network(userProfile.profilePicture).image,
                          ),
                        ))
                  ])),
          SizedBox(
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
            Container(
              child:
                  Text("${userProfile.username}", style: Styles.usernameStyle),
            )
          ]),
          SizedBox(
            height: 7,
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Text(" (${userProfile.reviewCount})",
                style: Styles.reviewCountStyle)
          ]),
          SizedBox(
            height: 10,
          ),
          Row(
            children: <Widget>[
              Container(
                child: isMe
                    ? ownProfileSettings(context)
                    : showReviewInputSection(context, userProfile.username),
              ),
            ],
          ),
        ],
