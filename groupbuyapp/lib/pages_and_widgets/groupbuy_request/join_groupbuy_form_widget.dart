...
class _JoinFormState extends State<JoinGroupBuyForm> {
  ...
  Widget createInputCard({
    ...
    TextEditingController amtController =
        TextEditingController(text: item != null ? item.totalAmount.toString() : null);
                          ...
                          child: Column(children: [
                            ...
                            Container(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                      Text('TOTAL', style: Styles.moneyStyle),
                                      Text('\$${printNumber(getTotal(), dp: 2)}', style: Styles.moneyStyle)
                                    ]),
                                    SizedBox(height: 7),
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                      Text('DEPOSIT', style: Styles.moneyStyle),
                                      Text('\$${printNumber(getTotal() * widget.deposit, dp: 2)}',
